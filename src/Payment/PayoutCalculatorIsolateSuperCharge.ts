...
import { PayoutDetails,PayoutTransaction } from "../core/payout-calculator/payout-calculator-isolate-supercharge";
...
export class PayoutCalculatorIsolateSuperCharge implements IPayoutCalculator {
    getPayouts(blocks: Block[], stakers: Stake[], totalStake: number, commisionRate: number): Promise<[payoutJson: any[], storePayout: any[], blocksIncluded: number[], totalPayout: number]> {
